  ...
  <div class="col p-0 d-flex justify-content-center align-items-center ">   
      <form class="w-75">
        <h1 class="mb-5 text-primary bastian">Masuk ke akunmu</h1>
            ...
            <div class="row m-0 h-100">
              <div class="col p-0 d-flex justify-content-center align-items-center mt-4 shadow p-3 mb-5 bg-body rounded-4 manyu m-4">
                <a href="/" class="text-dark text-decoration-none manyu">
                  <img data-v-483079c7="" data-v-3bc9487c="" src="https://www.static-src.com/frontend/member/static/3.90.0-1/desktop/img/facebook.3cbc9602.svg">Facebook</a>
              </div>
      
              <div class="col p-0 d-flex justify-content-center align-items-center mt-4 shadow p-3 mb-5 bg-body rounded-4 m-4">
                <a href="/" class="text-dark text-decoration-none manyu">
                  <img src="/image/google.svg" alt="" style="height: 30px;">google</a>
              </div>
            </div>
            <div class="col mt-n2 d-flex justify-content-center align-items-center">
              <p class="text-secondary">tidak punya akun?<a href="" class="text-decoration-none">daftar</a></p>
          </div>
      </form>
  </div> 
</div>
